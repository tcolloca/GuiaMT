<?php
	...
	if( isset( $_POST['modify'] ) && isset( $_POST['validation'] ) && isset( $_POST['newfile'] ) && $_POST['newfile'] != "" ){
			...
			for( $i = 1; file_exists(ROOT."/".$page.'intro'.$i.'.html'); $i++ )
				;
			copy(ROOT."/".$page.'intro.html', ROOT."/".$page.'intro'.$i.'.html');
		
			file_put_contents (ROOT."/".$page.'intro.html', $_POST['newfile']);
		...
		if( file_exists(ROOT."/".$page.'intro.html') )			
			$fileHTML = file(ROOT."/".$page.'intro.html');
