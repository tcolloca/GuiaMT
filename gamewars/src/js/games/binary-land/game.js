...
(function (BinaryLand) {
    ...
    class binaryLand {
        ...
        create() {
            ...
            for (var i = 0; i < this.game.height / 40; i++) {
                for (var j = 0; j < this.game.width / 40; j++) {
                    if (i == 0 || j == 0 || i == this.game.height / 40 - 1 || j == this.game.width / 40 - 1) {
                        var wall = this.game.add.sprite(j * 40, i * 40, 'wall');
                        wall.width = 40;
                        wall.height = 40;
            ...
            var positions = [[2, 2], [3, 2], [4, 2], [6, 2], [7, 2], [8, 2], [10, 2], [11, 2], [12, 2], [14, 2], [15, 2],
        ...
        update() {
            ...
            if (this.pinkPenguin.position.x <= pinkPositionX + 40 &&
    ...
    BinaryLand.binaryLand = binaryLand;
})(BinaryLand || (BinaryLand = {}));
window.onload = () => {
